...
local _Current_Heist = "election_day_1"
...
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_truck"),
...
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_gate"),
	menu_id = "RNGModifier_election_day_1_Options_Menu"
})
MenuCallbackHandler.RNGModifier_election_day_1_chance_of_container = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_chance_of_container")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_chance_of_container"),
	menu_id = "RNGModifier_election_day_1_Options_Menu"
})
