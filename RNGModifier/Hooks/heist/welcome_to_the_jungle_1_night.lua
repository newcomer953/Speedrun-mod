...
local _Current_Heist = "welcome_to_the_jungle_1_night"
local _bool = true
...
MenuCallbackHandler.RNGModifier_welcome_to_the_jungle_1_night_chanceOfTrade10 = function(self, item)
	if tostring(item:value()) == "on" then
		RNGModifier:SafeSetData(1, _Current_Heist, "_chanceOfTrade10")
	else
		RNGModifier:SafeSetData(0, _Current_Heist, "_chanceOfTrade10")
	end
	RNGModifier:Save()
end
_bool = tonumber(RNGModifier:SafeGetData(_Current_Heist, "_chanceOfTrade10")) == 1 and true or false
...
MenuCallbackHandler.RNGModifier_welcome_to_the_jungle_1_night_table_1 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_table_1")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_table_1"),
	menu_id = "RNGModifier_welcome_to_the_jungle_1_night_Options_Menu"
})

MenuCallbackHandler.RNGModifier_welcome_to_the_jungle_1_night_table_2 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_table_2")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_table_2"),
	menu_id = "RNGModifier_welcome_to_the_jungle_1_night_Options_Menu"
})
MenuCallbackHandler.RNGModifier_welcome_to_the_jungle_1_night_table_3 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_table_3")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_table_3"),
	menu_id = "RNGModifier_welcome_to_the_jungle_1_night_Options_Menu"
})
...
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_safe1"),
	menu_id = "RNGModifier_welcome_to_the_jungle_1_night_Options_Menu"
})

--[[MenuCallbackHandler.RNGModifier_welcome_to_the_jungle_1_night_test = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_test")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	id = "RNGModifier_welcome_to_the_jungle_1_night_test",
	title = "RNGModifier_welcome_to_the_jungle_1_night_test_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_welcome_to_the_jungle_1_night_test",
	items = {
		"RNGModifier_Default_One_Item",
