...
MenuCallbackHandler.RNGModifier_pex_it = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_it")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_pex_tag = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_tag")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_pex_prisoner = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_prisoner")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_pex_evidence = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_evidence")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_pex_sm_suit = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_sm_suit")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_pex_armory = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_armory")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_pex_ms_locker = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_ms_locker")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_pex_ml_locker = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_ml_locker")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_pex_ls_locker = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_ls_locker")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_pex_parking = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_parking")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
