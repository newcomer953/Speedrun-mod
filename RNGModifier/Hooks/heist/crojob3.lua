...
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData("crojob3", "_wagon_1"),
	menu_id = "RNGModifier_crojob3_Options_Menu"
})

MenuCallbackHandler.RNGModifier_crojob3_wagon_2 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_wagon_2")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	priority = -1.2,
	id = "RNGModifier_crojob3_wagon_2",
	title = "RNGModifier_crojob3_wagon_2_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_crojob3_wagon_2",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_crojob3_wagon_choice_7",
		"RNGModifier_crojob3_wagon_choice_9",
	...
	value = RNGModifier:SafeGetData("crojob3", "_wagon_2"),
	menu_id = "RNGModifier_crojob3_Options_Menu"
})


MenuCallbackHandler.RNGModifier_crojob3_wagon_3 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_wagon_3")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	priority = -1.3,
	id = "RNGModifier_crojob3_wagon_3",
	title = "RNGModifier_crojob3_wagon_3_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_crojob3_wagon_3",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_crojob3_wagon_choice_7",
		"RNGModifier_crojob3_wagon_choice_9",
	...
	value = RNGModifier:SafeGetData("crojob3", "_wagon_3"),
	menu_id = "RNGModifier_crojob3_Options_Menu"
})

MenuCallbackHandler.RNGModifier_crojob3_wagon_4 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_wagon_4")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	priority = -1.4,
	id = "RNGModifier_crojob3_wagon_4",
	title = "RNGModifier_crojob3_wagon_4_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_crojob3_wagon_4",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_crojob3_wagon_choice_7",
		"RNGModifier_crojob3_wagon_choice_9",
	...
	value = RNGModifier:SafeGetData("crojob3", "_wagon_4"),
	menu_id = "RNGModifier_crojob3_Options_Menu"
})


MenuCallbackHandler.RNGModifier_crojob3_wagon_5 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_wagon_5")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	priority = -1.5,
	id = "RNGModifier_crojob3_wagon_5",
	title = "RNGModifier_crojob3_wagon_5_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_crojob3_wagon_5",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_crojob3_wagon_choice_7",
		"RNGModifier_crojob3_wagon_choice_9",
	...
	value = RNGModifier:SafeGetData("crojob3", "_wagon_5"),
	menu_id = "RNGModifier_crojob3_Options_Menu"
})
...
MenuCallbackHandler.RNGModifier_crojob3_bomb_case = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_bomb_case")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	id = "RNGModifier_crojob3_bomb_case",
	title = "RNGModifier_crojob3_bomb_case_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_crojob3_bomb_case",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_number_4_use_1",
		"RNGModifier_number_4_use_2"				
	},
	value = RNGModifier:SafeGetData("crojob3", "_bomb_case"),
	menu_id = "RNGModifier_crojob3_Options_Menu"
})
