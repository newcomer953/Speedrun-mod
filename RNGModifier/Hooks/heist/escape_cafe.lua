...
local _Current_Heist = "escape_cafe"
RNGModifier._data = RNGModifier._data or {}
RNGModifier._data[_Current_Heist] = RNGModifier._data[_Current_Heist] or {}

MenuCallbackHandler.RNGModifier_escape_cafe_esc = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_esc")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	id = "RNGModifier_escape_cafe_esc",
	title = "RNGModifier_escape_cafe_esc_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_escape_cafe_esc",
	items = {
...
MenuCallbackHandler.RNGModifier_escape_cafe_wait_time = function(self, item)
...
MenuHelper:AddToggle({
	id = "RNGModifier_escape_cafe_wait_time",
	title = "RNGModifier_escape_cafe_wait_time_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_escape_cafe_wait_time",
