...
local _Current_Heist = "shoutout_raid"
...
MenuCallbackHandler.RNGModifier_shoutout_raid_containerA = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_containerA")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	items = {
		...
		"RNGModifier_shoutout_raid_container_1",
		"RNGModifier_shoutout_raid_container_2",
		"RNGModifier_shoutout_raid_container_3",
		"RNGModifier_shoutout_raid_container_4",
		"RNGModifier_shoutout_raid_container_5",
		"RNGModifier_shoutout_raid_container_6",
		"RNGModifier_shoutout_raid_container_7"
	},
	value = RNGModifier:SafeGetData(_Current_Heist, "_containerA"),
...
MenuCallbackHandler.RNGModifier_shoutout_raid_containerB = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_containerB")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_shoutout_raid_container_8",
		"RNGModifier_shoutout_raid_container_9",
		"RNGModifier_shoutout_raid_container_10",
		"RNGModifier_shoutout_raid_container_11",
		"RNGModifier_shoutout_raid_container_12",
		"RNGModifier_shoutout_raid_container_13"
	},
	value = RNGModifier:SafeGetData(_Current_Heist, "_containerB"),
	menu_id = "RNGModifier_shoutout_raid_Options_Menu"
})
...
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_crowbar_A"),
	menu_id = "RNGModifier_shoutout_raid_Options_Menu"
})
...
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_crowbar_B"),
	menu_id = "RNGModifier_shoutout_raid_Options_Menu"
})
...
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_cage"),
	menu_id = "RNGModifier_shoutout_raid_Options_Menu"
})
...
MenuCallbackHandler.RNGModifier_shoutout_raid_70_chance = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_70_chance")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_70_chance"),
	menu_id = "RNGModifier_shoutout_raid_Options_Menu"
})
