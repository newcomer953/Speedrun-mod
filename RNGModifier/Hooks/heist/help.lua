...
MenuCallbackHandler.RNGModifier_help_next_wheel = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_next_wheel")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	id = "RNGModifier_help_next_wheel",
	title = "RNGModifier_help_next_wheel_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_help_next_wheel",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_help_next_wheel_1",
		"RNGModifier_help_next_wheel_2"
	},
	value = RNGModifier:SafeGetData("help", "_next_wheel"),
	menu_id = "RNGModifier_help_Options_Menu"
})