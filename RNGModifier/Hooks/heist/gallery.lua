...
MenuCallbackHandler.RNGModifier_gallery_painting = function(self, item)
...
MenuHelper:AddToggle({
	...
	id = "RNGModifier_gallery_painting",
	title = "RNGModifier_framing_frame_1_painting_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_gallery_painting",
...
MenuCallbackHandler.RNGModifier_gallery_no_car = function(self, item)
	if tostring(item:value()) == "on" then
...
MenuHelper:AddToggle({
	priority = GetPriority(),
	id = "RNGModifier_gallery_no_car",
	title = "RNGModifier_framing_frame_1_no_car_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_gallery_no_car",
