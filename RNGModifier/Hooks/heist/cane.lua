...
MenuCallbackHandler.RNGModifier_cane_chimney = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_chimney")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	id = "RNGModifier_cane_chimney",
	title = "RNGModifier_cane_chimney_title",
	desc = "RNGModifier_cane_chimney_desc",
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_chimney"),
	menu_id = "RNGModifier_cane_Options_Menu"
})

MenuCallbackHandler.RNGModifier_cane_elf1 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_elf1")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_elf1"),
	menu_id = "RNGModifier_cane_Options_Menu"
})

MenuCallbackHandler.RNGModifier_cane_elf2 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_elf2")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_elf2"),
	menu_id = "RNGModifier_cane_Options_Menu"
})
...
MenuCallbackHandler.RNGModifier_cane_pick = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_pick")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_pick"),
	menu_id = "RNGModifier_cane_Options_Menu"
})
