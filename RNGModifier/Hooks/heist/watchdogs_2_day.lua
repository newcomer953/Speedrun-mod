...
local _Current_Heist = "watchdogs_2_day"
...
MenuCallbackHandler.RNGModifier_watchdogs_2_day_gate = function(self, item)
...
MenuHelper:AddToggle({
	...
	id = "RNGModifier_watchdogs_2_day_gate",
	title = "RNGModifier_watchdogs_2_day_gate_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_watchdogs_2_day_gate",
...
MenuHelper:AddMultipleChoice({
	...
	items = {
		...
		"RNGModifier_watchdogs_2_day_boat_001",
		"RNGModifier_watchdogs_2_day_boat_002",
		"RNGModifier_watchdogs_2_day_boat_003"
	},
	value = RNGModifier:SafeGetData(_Current_Heist, "_boat"),
	menu_id = "RNGModifier_watchdogs_2_day_Options_Menu"
})

MenuCallbackHandler.RNGModifier_watchdogs_2_day_delay = function(self, item)
	if tostring(item:value()) == "on" then
...
MenuHelper:AddToggle({
	priority = GetPriority(),
	id = "RNGModifier_watchdogs_2_day_delay",
	title = "RNGModifier_watchdogs_2_day_delay_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_watchdogs_2_day_delay",
	value = tonumber(RNGModifier:SafeGetData(_Current_Heist, "_delay")) == 1,
	menu_id = "RNGModifier_" .. _Current_Heist .. "_Options_Menu"
})

MenuCallbackHandler.RNGModifier_watchdogs_2_day_heli = function(self, item)
	if tostring(item:value()) == "on" then
...
MenuHelper:AddToggle({
	priority = GetPriority(),
	id = "RNGModifier_watchdogs_2_day_heli",
	title = "RNGModifier_watchdogs_2_day_heli_title",
	desc = "RNGModifier_watchdogs_2_heli_desc",
	callback = "RNGModifier_watchdogs_2_day_heli",
