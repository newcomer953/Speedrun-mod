...
MenuCallbackHandler.RNGModifier_man_roof_or_fall = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_roof_or_fall")
	RNGModifier:Save()
end
...
MenuCallbackHandler.RNGModifier_man_roof_boxes = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_roof_boxes")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_man_building_boxes = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_building_boxes")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	id = "RNGModifier_man_building_boxes",
	title = "RNGModifier_man_building_boxes_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_man_building_boxes",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_man_building_boxes_1",
		"RNGModifier_man_building_boxes_2",
		"RNGModifier_man_building_boxes_3",
		"RNGModifier_man_building_boxes_4"
	},
	value = RNGModifier:SafeGetData("man", "_building_boxes"),
	menu_id = "RNGModifier_man_Options_Menu"
})
...
MenuCallbackHandler.RNGModifier_man_limo = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_limo")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_man_balcony = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_balcony")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_man_wall = function(self, item)
	if tostring(item:value()) == "on" then
		RNGModifier:SafeSetData(1, _Current_Heist, "_wall")
	else
		RNGModifier:SafeSetData(0, _Current_Heist, "_wall")
	end
	RNGModifier:Save()
end
MenuHelper:AddToggle({
	priority = GetPriority(),
	id = "RNGModifier_man_wall",
	title = "RNGModifier_man_wall_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_man_wall",
	value = tonumber(RNGModifier:SafeGetData(_Current_Heist, "_wall")) == 1,
