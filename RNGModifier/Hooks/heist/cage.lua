...
MenuCallbackHandler.RNGModifier_cage_pick1_correct_computer = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_pick1_correct_computer")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_pick1_correct_computer"),
	menu_id = "RNGModifier_cage_Options_Menu"
})

MenuCallbackHandler.RNGModifier_cage_choose_storage = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_choose_storage")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_choose_storage"),
	menu_id = "RNGModifier_cage_Options_Menu"
})
...
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_manager"),
	menu_id = "RNGModifier_cage_Options_Menu"
})

MenuCallbackHandler.RNGModifier_cage_spawn = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_spawn")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	id = "RNGModifier_cage_spawn",
	title = "RNGModifier_cage_spawn_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_cage_spawn",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_cage_spawn_1",
		"RNGModifier_cage_spawn_2"
	},
