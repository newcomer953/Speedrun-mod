...
MenuHelper:AddMultipleChoice({
	...
	desc = "RNGModifier_jolly_spawn_desc",
...
MenuCallbackHandler.RNGModifier_jolly_lower_van_spawn = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_lower_van_spawn")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_lower_van_spawn"),
	menu_id = "RNGModifier_jolly_Options_Menu"
})

MenuCallbackHandler.RNGModifier_jolly_upper_van_spawn = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_upper_van_spawn")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_upper_van_spawn"),
	menu_id = "RNGModifier_jolly_Options_Menu"
})
...
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Current_Heist, "_c4"),
	menu_id = "RNGModifier_jolly_Options_Menu"
})
