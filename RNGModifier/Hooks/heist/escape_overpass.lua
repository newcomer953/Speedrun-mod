...
MenuHelper:AddMultipleChoice({
	...
	menu_id = "RNGModifier_escape_overpass_Options_Menu"
})

MenuCallbackHandler.RNGModifier_escape_overpass_wait_time = function(self, item)
