...
MenuCallbackHandler.RNGModifier_bex_blue = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_blue")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_bex_tape = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_tape")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_bex_green = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_green")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_bex_computer1 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_computer1")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_bex_red = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_red")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_bex_yellow = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_yellow")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_bex_safe1 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_safe1")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_bex_safe2 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_safe2")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_bex_manager = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_manager")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_bex_manual = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_manual")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_bex_color_A = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_color_A")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_bex_color_B = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_color_B")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_bex_security = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_security")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
...
MenuCallbackHandler.RNGModifier_bex_escape = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_escape")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	id = "RNGModifier_bex_escape",
	title = "RNGModifier_bex_escape_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_bex_escape",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_bex_escape_1",
		"RNGModifier_bex_escape_2"
	},
	value = RNGModifier:SafeGetData("bex", "_escape"),
	menu_id = "RNGModifier_bex_Options_Menu"
})

MenuCallbackHandler.RNGModifier_bex_powerbox = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_powerbox")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	id = "RNGModifier_bex_powerbox",
	title = "RNGModifier_bex_powerbox_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_bex_powerbox",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_bex_powerbox_1",
		"RNGModifier_bex_powerbox_2"
	},
	value = RNGModifier:SafeGetData("bex", "_powerbox"),
	menu_id = "RNGModifier_bex_Options_Menu"
})

MenuCallbackHandler.RNGModifier_bex_powerhouse1 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_powerhouse1")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	id = "RNGModifier_bex_powerhouse1",
	title = "RNGModifier_bex_powerhouse1_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_bex_powerhouse1",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_bex_powerhouse1_1",
		"RNGModifier_bex_powerhouse1_2"
	},
	value = RNGModifier:SafeGetData("bex", "_powerhouse1"),
	menu_id = "RNGModifier_bex_Options_Menu"
})

MenuCallbackHandler.RNGModifier_bex_powerhouse2 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_powerhouse2")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	id = "RNGModifier_bex_powerhouse2",
	title = "RNGModifier_bex_powerhouse2_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_bex_powerhouse2",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_bex_powerhouse2_1",
		"RNGModifier_bex_powerhouse2_2"
	},
	value = RNGModifier:SafeGetData("bex", "_powerhouse2"),
	menu_id = "RNGModifier_bex_Options_Menu"
})

MenuCallbackHandler.RNGModifier_bex_rnd_server_room = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_rnd_server_room")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	id = "RNGModifier_bex_rnd_server_room",
	title = "RNGModifier_bex_rnd_server_room_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_bex_rnd_server_room",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_bex_rnd_server_room_1",
		"RNGModifier_bex_rnd_server_room_2",
		"RNGModifier_bex_rnd_server_room_3",
		"RNGModifier_bex_rnd_server_room_4"
	},
	value = RNGModifier:SafeGetData("bex", "_rnd_server_room"),
	menu_id = "RNGModifier_bex_Options_Menu"
})

MenuCallbackHandler.RNGModifier_bex_rnd_mid_manual_location = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_rnd_mid_manual_location")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	id = "RNGModifier_bex_rnd_mid_manual_location",
	title = "RNGModifier_bex_rnd_mid_manual_location_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_bex_rnd_mid_manual_location",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_bex_rnd_mid_manual_location_1",
		"RNGModifier_bex_rnd_mid_manual_location_2"
	},
	value = RNGModifier:SafeGetData("bex", "_rnd_mid_manual_location"),
	menu_id = "RNGModifier_bex_Options_Menu"
})

MenuCallbackHandler.RNGModifier_bex_door = function(self, item)
	if tostring(item:value()) == "on" then
		RNGModifier:SafeSetData(1, _Current_Heist, "_door")
	else
		RNGModifier:SafeSetData(0, _Current_Heist, "_door")
	end
	RNGModifier:Save()
end
MenuHelper:AddToggle({
	id = "RNGModifier_bex_door",
	title = "RNGModifier_bex_door_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_bex_door",
	value = tonumber(RNGModifier:SafeGetData(_Current_Heist, "_door")) == 1,
