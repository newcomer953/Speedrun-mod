...
local _Current_Heist = "welcome_to_the_jungle_1"
local _bool = true
...
--[[MenuCallbackHandler.RNGModifier_welcome_to_the_jungle_1_test = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_test")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	id = "RNGModifier_welcome_to_the_jungle_1_test",
	title = "RNGModifier_welcome_to_the_jungle_1_test_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_welcome_to_the_jungle_1_test",
	items = {
		"RNGModifier_Default_One_Item",
