...
local _Current_Heist = "election_day_3_skip1"
...
MenuCallbackHandler.RNGModifier_election_day_3_skip1_door = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_door")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	priority = GetPriority(),
	id = "RNGModifier_election_day_3_skip1_door",
	title = "RNGModifier_election_day_3_skip1_door_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_election_day_3_skip1_door",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_election_day_3_skip1_door_1",
		"RNGModifier_election_day_3_skip1_door_2"
	},
	value = RNGModifier:SafeGetData(_Current_Heist, "_door"),
	menu_id = "RNGModifier_election_day_3_skip1_Options_Menu"
})

MenuCallbackHandler.RNGModifier_election_day_3_skip1_pc = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_pc")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	priority = GetPriority(),
	id = "RNGModifier_election_day_3_skip1_pc",
	title = "RNGModifier_election_day_3_skip1_pc_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_election_day_3_skip1_pc",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_election_day_3_skip1_pc_1",
		"RNGModifier_election_day_3_skip1_pc_2",
		"RNGModifier_election_day_3_skip1_pc_3",
		"RNGModifier_election_day_3_skip1_pc_4",
		"RNGModifier_election_day_3_skip1_pc_5"
	},
	value = RNGModifier:SafeGetData(_Current_Heist, "_pc"),
	menu_id = "RNGModifier_election_day_3_skip1_Options_Menu"
})

MenuCallbackHandler.RNGModifier_election_day_3_skip1_chance_of_crash = function(self, item)
...
MenuHelper:AddToggle({
	priority = GetPriority(),
	id = "RNGModifier_election_day_3_skip1_chance_of_crash",
	title = "RNGModifier_election_day_3_skip1_chance_of_crash_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_election_day_3_skip1_chance_of_crash",
	value = tonumber(RNGModifier:SafeGetData(_Current_Heist, "_chance_of_crash")) == 1 and true or false,
	menu_id = "RNGModifier_election_day_3_skip1_Options_Menu"
})

MenuCallbackHandler.RNGModifier_election_day_3_skip1_vault_chance = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Current_Heist, "_vault_chance")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	priority = GetPriority(),
	id = "RNGModifier_election_day_3_skip1_vault_chance",
	title = "RNGModifier_election_day_3_skip1_vault_chance_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_election_day_3_skip1_vault_chance",
	items = {
		"RNGModifier_Default_One_Item",
		"RNGModifier_election_day_3_skip1_vault_chance_1",
		"RNGModifier_election_day_3_skip1_vault_chance_2"
	},
...
MenuCallbackHandler.RNGModifier_election_day_3_skip1_murphys_law = function(self, item)
	if tostring(item:value()) == "on" then
...
MenuHelper:AddToggle({
	priority = GetPriority(),
	id = "RNGModifier_election_day_3_skip1_murphys_law",
	title = "RNGModifier_election_day_3_skip1_murphys_law_title",
	desc = "RNGModifier_empty_desc",
	callback = "RNGModifier_election_day_3_skip1_murphys_law",
